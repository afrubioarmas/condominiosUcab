...
/**
 * This is the model class for table "correoelectronico".
 *
 * The followings are the available columns in table 'correoelectronico':
 * @property integer $idCorrecoElectronico
 ...
 */
class Correoelectronico extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('Direccion, Oficina_idOficina, Oficina_Empresa_RIF, Propietario_Cedula, TrabajadorEdificio_Cedula, TrabajadorEmpresa_Cedula, TrabajadorEmpresa_Oficina_idOficina, TrabajadorEmpresa_Oficina_Empresa_RIF', 'required'),
			array('Oficina_idOficina, Oficina_Empresa_RIF, Propietario_Cedula, TrabajadorEdificio_Cedula, TrabajadorEmpresa_Cedula, TrabajadorEmpresa_Oficina_idOficina, TrabajadorEmpresa_Oficina_Empresa_RIF', 'numerical', 'integerOnly'=>true),
			array('Direccion', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idCorrecoElectronico, Direccion, Oficina_idOficina, Oficina_Empresa_RIF, Propietario_Cedula, TrabajadorEdificio_Cedula, TrabajadorEmpresa_Cedula, TrabajadorEmpresa_Oficina_idOficina, TrabajadorEmpresa_Oficina_Empresa_RIF', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'idCorrecoElectronico' => 'Id Correco Electronico',
			'Direccion' => 'Direccion',
	...
	public function search()
	{
		...
		$criteria->compare('idCorrecoElectronico',$this->idCorrecoElectronico);
	 ...
	 * @return Correoelectronico the static model class
	 */
